			...
			<div class="col-10">
				<div class="row">
					<div class="top-action">
						<div class="tv-tabs">
						  <label class="tv-tab" for="tv-tab-1">Account Payables</label>
						</div>
						  	...
						  	<form action="">
						  		<div class="row">
						  			<div class="col-3">
								  		...
								  		<select name="payable_acc" class="form-control" id="">
								  			<option>Select Payable Account</option>
								  			<option value="1">Staff Salary</option>
								  			<option value="2">Utility Bills</option>
								  			<option value="3">Rental Expense</option>
								  		</select>
								  		<input type="text" name="particular" id="" class="form-control" placeholder="Payable Description">
								  		<input type="text" name="payable_amount" id="" class="form-control" placeholder="Payable Amount">
								  		<input type="text" name="payable_ageing" id="" class="form-control" placeholder="Payable Ageing">
						  			</div>
						  		</div>
						  		<div class="row">
						  			<div class="col-12">
