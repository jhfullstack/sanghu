			...
			<div class="col-10">
				<div class="row">
					<div class="top-action">
						<div class="tv-tabs">
						  <label class="tv-tab" for="tv-tab-1">Cattles Basic Data</label>
						  <label class="tv-tab" for="tv-tab-2">Additional Information</label>
						  <label class="tv-tab" for="tv-tab-3">Animal Group</label>
						</div>
						<input class="tv-radio" id="tv-tab-1" name="tv-group" type="radio" checked="checked"/>
						<div class="tv-content">
						  <h3>Cattles Basic Data</h3>
						  <p><i>Fill up. *marks are mandatory field!</i></p>
						  <div class="entry-form">
						  	<form action="">
						  		<div class="row">
						  			<div class="col-2">
						  				<input type="text" class="form-control" placeholder="Cattle ID">
						  			</div>
						  			<div class="col-3">
						  				<select name="cattle_type" class="form-control" id="">
