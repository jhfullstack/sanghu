			...
			<div class="col-10">
				<div class="row">
					<div class="top-action">
						<div class="tv-tabs">
						  <label class="tv-tab" for="tv-tab-1">Earnings</label>
						</div>
						  	...
						  	<form action="">
						  		<div class="row">
						  			<div class="col-3">
								  		...
								  		<select name="earnings_type" class="form-control" id="">
								  			<option>Earnings Type</option>
								  			<option value="1">Incentive</option>
								  			<option value="2">Bonus</option>
								  			<option value="3">Overtime</option>
								  		</select>
								  		<input type="text" name="earning_amount" id="" class="form-control" placeholder="Earning Amount">
								  		<textarea name="earning_desc" id="" cols="30" rows="10" class="form-control" placeholder="Earning Description"></textarea>
						  			</div>
						  		</div>
						  		<div class="row">
						  			<div class="col-12">
