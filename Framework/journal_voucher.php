				...
				<div class="row">
					<div class="top-action">
						...
						<div class="tv-content">
						  <h3>Journal Voucher : Jamuna Micro Credit</h3>
						  <p><i>Fill up. *marks are mandatory field!</i></p>
						  <div class="entry-form">
						  	<form action="">
						  		<div class="row">
						  			<div class="col-3">
								  		<input type="text" name="trx_id" id="" class="form-control" placeholder="JV001001">
						  				<select name="company_id" class="form-control" id="">
								  			<option>Select Company</option>
								  			<option value="1">Jamuna Micro Credit</option>
								  			<option value="2">Sanghu Farm & Agro Vet</option>
								  		</select>
								  		<select name="adj_method" class="form-control" id="">
								  			<option>Select Adjustment Method</option>
								  		...
								  		<input type="text" name="adj_amount" id="" class="form-control" placeholder="Adjustment Amount">
						...
						<div class="tv-content">
						  <h3>Journal Voucher : Sanghu Valley Cold Storage</h3>
						  <p><i>Fill up. *marks are mandatory field!</i></p>
						  <div class="entry-form">
						  	<form action="">
						  		<div class="row">
						...
						<div class="tv-content">
						  <h3>Journal Voucher : Sanghu Farm & Agro Vet</h3>
						  <p><i>Fill up. *marks are mandatory field!</i></p>
						  <div class="entry-form">
						  	<form action="">
						  		<div class="row">
						...
						<div class="tv-content">
						  <h3>Journal Voucher : Sanghu Corporate</h3>
						  <p><i>Fill up. *marks are mandatory field!</i></p>
						  <div class="entry-form">
						  	<form action="">
						  		<div class="row">
